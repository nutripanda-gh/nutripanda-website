...
const GUMMIES = [
  ...
  { id: 3, className: "top-[62%] sm:top-[50%] left-[14%]",   size: 100, delay: "0.8s", duration: "5.5s", rotate: "10deg" },
  { id: 4, className: "top-[60%] sm:top-[48%] right-[14%]",  size: 100, delay: "2s",   duration: "6.5s", rotate: "-25deg" },
];
